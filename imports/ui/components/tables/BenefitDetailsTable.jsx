...
class BenefitDetailsTable extends React.Component {
    constructor(props) {
        super(props);
        ...
        return (
            <Col sm={10} className='custom-table'>
                <BootstrapTable hover tableHeaderClass='table-header' tableBodyClass='table-body' data={this.props.benefits}>
                    ...
                    {!this.props.isManager && !this.props.isEmployee && !this.props.isHR && <TableHeaderColumn dataField='benefitDetailControls' dataFormat={this.benefitDetailControlsFormatter}></TableHeaderColumn>}
                </BootstrapTable>
            </Col>
        );
    }
...
export default BenefitDetailsTable;